<?php
/*
 * Стенд: Hostland. Корень MODX (htdocs сайта mspaypalalt): art-sites.ru/htdocs/mspaypalalt/
 * modxbuilder/ лежит внутри корня MODX. Запуск из домашнего каталога (где лежит art-sites.ru):
 *
 * /usr/local/php/php-7.4/bin/php -d display_errors -d error_reporting=E_ALL art-sites.ru/htdocs/mspaypalalt/modxbuilder/mxlogger/build/build.schema.php
 * /usr/local/php/php-7.4/bin/php -d display_errors -d error_reporting=E_ALL art-sites.ru/htdocs/mspaypalalt/modxbuilder/mxlogger/build/build.models.php
 * /usr/local/php/php-7.4/bin/php -d display_errors -d error_reporting=E_ALL art-sites.ru/htdocs/mspaypalalt/modxbuilder/mxlogger/build/build.package.php
 *
 * Модель и map написаны вручную — build.schema/build.models можно пропустить и сразу
 * собирать пакет build.package.php. Готовый .transport.zip появится в
 * art-sites.ru/htdocs/mspaypalalt/core/packages/.
 */
